        ...
        <div className='mb-5'>
            <div className='mid-content'>
                ...
                <div className='grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 lg:mt-10 mt-5  shadow-xl'>
                    <div className='border'><img className=' mx-auto py-3' src={img1} alt="" /></div>
                    <div className='border'><img className=' mx-auto py-3' src={img2} alt="" /></div>
                    <div className='border'><img className=' mx-auto py-3' src={img3} alt="" /></div>
                    <div className='border'><img className=' mx-auto py-3' src={img4} alt="" /></div>
                    <div className='border'><img className=' mx-auto py-3' src={img5} alt="" /></div>
                    <div className='border'><img className=' mx-auto py-3' src={img6} alt="" /></div>
                </div>
            </div>
        </div>
    );
